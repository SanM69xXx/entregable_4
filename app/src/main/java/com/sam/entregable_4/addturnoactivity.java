...
public class addturnoactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addturnoactivity);

        //bind views
        quoteEditText = (EditText) findViewById(R.id.editTextcita);
        authorEditText = (EditText) findViewById(R.id.editTextcliente);
    ...
    private void addQuoteToDB(String quote, String author) {
        ...
        DatabaseReference quotesRef = database.getReference("citas");
        ...
        quotesRef.child(key).setValue(quoteHashmap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(addturnoactivity.this, "Agendado", Toast.LENGTH_SHORT).show();
